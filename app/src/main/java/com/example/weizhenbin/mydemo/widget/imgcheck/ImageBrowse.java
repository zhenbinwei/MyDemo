...
public class ImageBrowse extends Fragment implements ViewPager.OnPageChangeListener{
    ...
    private List<String> srcUrls=new ArrayList<>();
    ...
    public boolean isNeedCloseHardwareAcceleration() {
        ...
        Log.d("ImageBrowse", "maxSize[0]:" + maxSize[0]);
        return false;
    }
    ...
    public void showImageBrowse(List<String> urls){
        urls.clear();
        addImageUrls(urls,0);
    }

    public void addImageUrls(List<String> urls,int index){
    ...
    public void onPageSelected(int position) {
        ...
        tvPoint.setText(itemCount+"/"+currentPosition);
    ...
    class ImageListAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Bitmap bitmap= BitmapFactory.decodeResource(container.getResources(),images[position]);
            img.setScaleType(ImageView.ScaleType.FIT_XY);
            img.setImageBitmap(compress(bitmap,maxTexture));
