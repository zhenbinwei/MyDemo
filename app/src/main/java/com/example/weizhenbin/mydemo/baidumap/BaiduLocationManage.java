 ...
 * @version V1.0
 * @Title: BaiduLocationManage
 * @ProjectName Show
 * @Package com.weizhenbin.show.baidumap
 * @date 2016/2/24 10:47
 * 单例 百度定位管理
 */
public class BaiduLocationManage {
    ...
    public static BaiduLocationManage getInstance(Context context) {
        if (instance == null) {
            instance = new BaiduLocationManage(context);
        }
        return instance;
    }
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            locationInfo.countryCode=(location.getCountryCode());
            ...
            locationInfo.addrStr=(location.getAddrStr());
            if(listeners!=null){
                int size=listeners.size();
                for (int i=0;i<size;i++){
                    listeners.get(i).onLocation(locationInfo);
                }
            }
    ...
    public void addLocationListener(OnLocationInfoListener listener) {
        if (listener != null && !listeners.contains(listener)) {
            listeners.add(listener);
        }
    }

    public void removeLocationListener(OnLocationInfoListener listener) {
        if (listener != null && listeners.contains(listener)) {
